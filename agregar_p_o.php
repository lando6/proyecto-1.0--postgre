...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/agregar_p_o.css">
...
<header>	
	<div id="ad">
		...
		<div id="verq">
			<a href="productos_a_o.php">
			<p><i class="icon-file-text2"></i> Lista de productos</p>
			</a>
		</div>
		<div id="exit">
			<a href="salir.php">
...
<body>
	<h1 id="title">Agregar otro producto</h1>
		...
		<table id="tb1">
			...
			<tr>
				<td><input 
					...
					value="Guardar"
					></td>
				<td><input type="hidden" name="i" value="5"></td>
			</tr>
		</table>
	</form>
</body>
